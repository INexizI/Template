...
class StudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post studios_url, params: { studio: { description: @studio.description, logotype: @studio.logotype, name: @studio.name } }
    end
  ...
  test "should update studio" do
    patch studio_url(@studio), params: { studio: { description: @studio.description, logotype: @studio.logotype, name: @studio.name } }
